...
export const DEFAULT_WALLET_UI_SETTINGS: WalletUiSettings = {
  ...
  defaultCurrency: "USD",
  startPage: "portal",
  visibleWidgets: ["balance", "assets", "send", "receive", "receive-request", "activity", "portfolio", "pufeth"],
  widgetOrder: ["balance", "assets", "send", "receive", "receive-request", "swap", "activity", "portfolio", "pufeth"],
  collapsedWidgets: [],
